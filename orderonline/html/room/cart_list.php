...
?>
  <table border="0" cellpadding="0" cellspacing="0" width="740">
    ...
    <tr>
      ...
      <td colspan="3" bgcolor="#F0E2C5">
        <div style="padding-right:50px; text-align:right">
          ...
          <input type="button" name="query" value=" 訂房 " class="input03" style="cursor:pointer;" onclick="location='../room/index.php'"/>
        </div>
      </td>
    ...
    <tr>
      <td colspan="3" rowspan="6" align="center" valign="top" bgcolor="#F0E2C5">
	  <div style="width:100%">
	  <?PHP
	  $lan="cht";
    ...
    <tr>
      <td colspan="3" valign="top" bgcolor="#F0E2C5"><p align="center">&nbsp;</p></td>
