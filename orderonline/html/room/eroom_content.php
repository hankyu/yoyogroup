...
?>
  <table border="0" align="center" cellpadding="0" cellspacing="0" width="740">
    ...
    <tr>
      ...
      <td rowspan="2" colspan="3"><img name="ordermenu_r2_c2" src="img/enordermenu_r2_c2.jpg" width="675" height="93" border="0" id="ordermenu_r2_c2" alt="" /></td>
    ...
    <tr>
      ...
      <td colspan="3" bgcolor="#F0E2C5"><div style="padding-right:50px; text-align:right">
        <input type="button" name="query" value=" Reservation Inquiry "  class="input03" onclick="location='../member/emember_area.php'"/> <input type="button" name="query" value=" Cart "  class="input03" onclick="location='../room/ecart_list.php'"/> <input type="button" name="query" value=" Room List "  class="input03" onclick="location='../room/eindex.php'"/></div></td>
      <td rowspan="9" background="img/ordermenu_r5_c6.jpg">&nbsp;</td>
      <td><img src="img/spacer.gif" width="1" height="5" border="0" alt="" /></td>
    </tr>
    <tr>
      <td colspan="3" rowspan="7" bgcolor="#F0E2C5">
	  <?PHP
	  $lan="eng";
	  include("../include/room_content.php");
	  ?>	  <p align="center">&nbsp;</p></td>
...
<?
include("file:///D|/AppServ/www/gohotel/include/foot.php");
?>