...
-->
  ...
  <table width="740" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
      ...
      <td colspan="3" rowspan="2" valign="middle" bgcolor="#F0E2C5" style="vertical-align:middle;">
        <div align="center">
      ...
      <!-- <td colspan="3" rowspan="2" valign="top" bgcolor="#F0E2C5"></td> -->
    ...
    <tr>
      ...
      <input type="button" name="query" value=" 查詢訂單 "  class="input03" onclick="location='../member/member_area.php'"/> <input type="button" name="query" value=" 購物車 "  class="input03" onclick="location='../room/cart_list.php'"/> <input type="button" name="query" value=" 訂房 " class="input03" onclick="location='../room/index.php'"/></div></td>
