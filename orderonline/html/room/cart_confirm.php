...
?>
  <table border="0" cellpadding="0" cellspacing="0" width="740">
    ...
    <tr>
      ...
      <td><img src="imgspacer.gif" width="1" height="37" border="0" alt="" /></td>
    </tr>
    <tr>
	  ...
	  SetReturnURL();
	  $lan="cht";
		  //if(!empty($_SESSION["smember_id"])||!empty($_SESSION["smember_password"])):
		  	include("../include/cart_confirm.php"); 
		  //else:
		  //	include("../include/member_login.php"); 
		  //endif;
	  ?>	  <p align="center">&nbsp;</p></td>
