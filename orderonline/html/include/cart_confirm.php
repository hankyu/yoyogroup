...
?>
  if(document.reg.order2_cell.value != ""){
	...
	?>
	if(cltxt.length!=10){
	  alert("<?=$lan=="cht"?"行動電話錯誤請檢查！":"The Cell Phone is Invailded. Please Check It!"?>");
	  document.reg.order2_cell.focus();
	  document.reg.order2_cell.value = "";
	  return (false);
	}
...
?>
        <tr align="center" bgcolor="#FFE0C1">
          <td bgcolor="#FFFFFF" class="tdList02"><?=$num?></td>
          <td bgcolor="#FFFFFF" class="tdList02"><?=view_kind($shopping_proname,$XFUN_TBL[TABLE_XFUN_rent],"rentNum",$pjName)?></td>
          <td bgcolor="#FFFFFF" class="tdList02"><?=$shopping_promodel?></td>
          <td bgcolor="#FFFFFF" class="tdList02"><?=$shopping_price1?></td>
          <td bgcolor="#FFFFFF" class="tdList02"><?=$shopping_amount?></td>
          <td bgcolor="#FFFFFF" class="tdList02"><?=$shopping_price1*$shopping_amount?></td>
        </tr>
<?
    }  //while_end
  else:
...
<table width="90%" border="0" align="center" cellpadding="3" cellspacing="1">
        <tr align="center">
          <td height="20" colspan="4" align="left" bgcolor="#FAF7F1" class="tdList00"><?=$lan=="cht"?"請確認您的資料是否正確，以免造成無法聯繫":"Please check user information carefully"?></td>
        </tr>
        <tr>
          <td width="170" height="2" align="left" valign="middle" class="tdList01"><?=$lan=="cht"?"訂購人姓名":"Full Name of Order Person"?><span class="style8">*</span></td>
            <td width="628" height="2" colspan="3" align="left" bgcolor="#F0E2C5"><input name="order2_name" type="text" class="text" id="order2_name" value="<?=$member_name?>" size="15" ></td>
        </tr>
        <tr>
          <td width="170" align="left" valign="middle" class="tdList01"><?=$lan=="cht"?"聯絡電話":"Phone Number"?><span class="style8">*</span></td>
            <td width="628" colspan="3" align="left" bgcolor="#F0E2C5"><input name="order2_phone" type="text" class="text" id="order2_phone" value="<?=$member_phone?>" size="15"><br>
              <font color="#990000">
            <?=$lan=="cht"?"請輸入區碼+電話號碼數字，不要有()或-符號":"Please input numbers, don’t  include ( ) or -"?></font> </td>
        </tr>
        
        <tr>
          <td width="170" height="0" align="left" valign="middle" class="tdList01"><?=$lan=="cht"?"行動電話":"Mobile Number"?><span class="style8">*</span></td>
            <td width="628" height="0" colspan="3" align="left" bgcolor="#F0E2C5"><input name="order2_cell" type="text" class="text" id="order2_cell" value="<?=$member_cell?>" size="15">
			<font color="#990000">
            <?=$lan=="cht"?"請輸入台灣手機10碼數字，不要有()或-符號":""?></font>			</td>
        </tr>
        <tr>
          <td height="0" align="left" valign="middle" class="tdList01"><?=$lan=="cht"?"電子信箱":"E-Mail"?><span class="style8">*</span></td>
          <td height="0" colspan="3" align="left" bgcolor="#F0E2C5" class=""><input name="order2_email" type="text" id="order2_email" value="<?=$member_email?>" class="text" /></td>
        </tr>
        <tr>
          <td height="0" align="left" valign="middle" class="tdList01"><?=$lan=="cht"?"聯絡地址":"Contact Address"?><span class="style8">*</span></td>
          <td width="628" height="0" colspan="3" align="left" bgcolor="#F0E2C5" class="">
		  <?
		  if($lan=="cht"){
		  ?>
...
<input name="add" type="text" id="add" value="" size="40"></td>
        ...
        <tr>
          <td width="170" align="left" valign="middle" class="tdList01"><?=$lan=="cht"?"住房人地址":"Occupant’s Address"?></td>
            <td width="628" colspan="3" align="left" bgcolor="#F0E2C5"><input name="order2_address" type="text" class="text" id="order2_address" size="40">
        ...
        <tr>
          <td width="170" align="left" valign="middle" class="tdList01"><?=$lan=="cht"?"住房人姓名":"Occupant’s Name "?></td>
            <td width="628" colspan="3" align="left" bgcolor="#F0E2C5"><input name="order2_recivename" type="text" class="text" id="order2_recivename" size="15">
	   ...
	   <table width="90%" border="0" align="center" cellpadding="3" cellspacing="1">
        <tr align="center">
          <td height="20" colspan="4" align="left" bgcolor="#FAF7F1" class="tdList00">開立統一編號</td>
        </tr>
        <tr>
          <td width="170" height="2" align="left" valign="middle" class="tdList01">發票型式<span class="style8">*</span></td>
            <td width="628" height="2" colspan="3" align="left" bgcolor="#F0E2C5"><input name="order_invoice_type" type="radio" value="不需開立" checked="checked" />
              不需開立
        ...
        <tr>
          <td width="170" align="left" valign="middle" class="tdList01">發票抬頭</td>
            <td width="628" colspan="3" align="left" bgcolor="#F0E2C5"><input name="invoice_title" type="text" class="text" id="invoice_title" size="20" /></td>
        </tr>
        
        <tr>
          <td height="0" align="left" valign="middle" class="tdList01">統一編號</td>
          <td height="0" colspan="3" align="left" bgcolor="#F0E2C5"><input name="invoice_num" type="text" class="text" id="invoice_num" size="20" /></td>
        </tr>
        <tr>
          <td width="170" height="0" align="left" valign="middle" class="tdList01">發票地址</td>
            <td width="628" height="0" colspan="3" align="left" bgcolor="#F0E2C5"><input name="invoice_address" type="text" class="text" id="invoice_address" size="40"  />
