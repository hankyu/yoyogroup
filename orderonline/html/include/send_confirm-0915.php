...
//===================斷定頁面是否重新整理========================
	...
	$body .= "您選擇的交易方式為：<font color=#639c00 size='3'><b>" .$order2_paykind. "</b></font>，請您儘快完成付款手續。<a href='http://".$XFUN_CONFIG[CONFIG_WEB_URL]."/orderonline/html/include/order_help.php'>→付款方式按此查看</a><br><br>";
	...
	$body .= "Type of Payment：<font color=#639c00 size='3'><b>" .$order2_paykind. "</b></font>，please check <a href='http://".$XFUN_CONFIG[CONFIG_WEB_URL]."/orderonline/html/include/order_help.php'>→Type of Payment</a>.<br><br>";
	...
	$body .= "<td width='50'　bgcolor='#659cd2'><div align='center'><font color='#FFFFFF' size='2'>".$d=$lan=="cht"?"數量":"Room(s)"."</td>";
	...
	if($lan=="cht"){
	$body .= "</table>";
	$body .= "<div align='center'><font color=#ec8000 size='3'>您需支付的總金額：" .$shopping_countTotal. "元 </font></div><br><br><br><font size='2'>請依照訂單所示金額及付款方式，於三日內完成付款手續，並於繳款完成後來電、傳真或e-mail告知飯店人員付款相關訊息。如逾期未完成付款確認，本訂單將自動取消不另行通知，且無法為您保留房間。<br><br>您也可至【<a href='".$XFUN_CONFIG[CONFIG_WEB_URL]."/orderonline/html/member/member_area.php'>訂單查詢</a>】系統查詢您的訂單處理進度。<br>若您有任何疑問歡迎您直接撥打客服專線，期待您的光臨，謝謝！<br><br><div align='center'>【客服專線：".$XFUN_CONFIG[CONFIG_WEB_PHONE]."】<br>【傳真號碼：".$XFUN_CONFIG[CONFIG_WEB_FAX]."】<br>【客服信箱：<a href='mailto:".$XFUN_CONFIG[CONFIG_WEB_EMAIL]."'>".$XFUN_CONFIG[CONFIG_WEB_EMAIL]."</a>】</div></font>";
	}else{
	$body .= "</table>";
	$body .= "<div align='center'><font color=#ec8000 size='3'>Total amount payable: NT ：" .$shopping_countTotal. "</font></div><br><br><br><font size='2'>The full payment of hotel accommodation should be completed within 3 days after you make an online booking. Your reservation is not confirmed until we receive your fax of “Credit Card Authorization Form” with cardholder’s signature. <br><br>Your reservation status can be checked online via the【<a href='".$XFUN_CONFIG[CONFIG_WEB_URL]."/orderonline/html/member/member_area.php'>Reservation Inquiry</a>】page.<br>For any further concerns, please don’t be hesitated to write us an E-Mail :<a href='mailto:".$XFUN_CONFIG[CONFIG_WEB_EMAIL]."'>".$XFUN_CONFIG[CONFIG_WEB_EMAIL]."</a> <br>
	Thanks for staying with us, and we look forward to serving you very soon.
	<br><div align='center'>【TEL：".$XFUN_CONFIG[CONFIG_WEB_PHONE]."】<br>【Fax：".$XFUN_CONFIG[CONFIG_WEB_FAX]."】<br>【Email：<a href='mailto:".$XFUN_CONFIG[CONFIG_WEB_EMAIL]."'>".$XFUN_CONFIG[CONFIG_WEB_EMAIL]."</a>】</div></font>";
	}
	$body .= "</td></tr></table>";
	$body .= "<div align='right'><a href='".$XFUN_CONFIG[CONFIG_WEB_URL]."'>".$f=$lan=="cht"?$XFUN_CONFIG[CONFIG_WEB_TITLE]:"The Enterpriser Hotel"."</a></div>";
	$body .= "</td></tr></table>";
