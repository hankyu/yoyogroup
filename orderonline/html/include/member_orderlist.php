...
global $lan;
	...
	case "A5":
		...
		break;
	case "A6":
		$Astatus=$lan=="cht"?"訂單失效 (未匯款)":"No Payment";
		echo "<font color=red>$Astatus</font>";
		break;
	case "A8":
...
<table width="90%" border="1" cellpadding="3" cellspacing="0" bordercolor="#cccccc" bordercolorlight="#cccccc" bordercolordark="#ffffff" bgcolor="#FFFFFF">
  <tr>
    <td height="13" align="left" valign="top" bgcolor="#F0E2C5"><input type="button" name="Submit" value=" <?=$lan=="cht"?"重新查詢":"Reset"?> " class="input03" onclick="location='<?=$phpself."?act=logout"?>'"/></td>
  </tr>
  <tr>
    <td width="1243" height="13" valign="top" bgcolor="#F0E2C5"><form id="myform" name="myform" method="post" action="<?=$phpself?>" onSubmit="return check(this)">
  <table width="100%" border="1" cellpadding="3" cellspacing="0" bordercolor="#cccccc" bordercolorlight="#cccccc" bordercolordark="#ffffff" bgcolor="#FFFFFF">
        <tr bgcolor="#B7B700">
          <td align="center" valign="middle" nowrap bgcolor="#FAF7F1" class="style13"> #</td>
          <td height="20" align="center" nowrap bgcolor="#FAF7F1" class="style13"><?=$lan=="cht"?"訂單編號":"Reservation Number"?></td>
          <td height="20" align="center" nowrap bgcolor="#FAF7F1" class="style13"><?=$lan=="cht"?"訂購總金額":"Total Amount"?></td>
          <td align="center" nowrap bgcolor="#FAF7F1" class="style13"><?=$lan=="cht"?"付款方式":"Type of Payment"?></td>
          <td align="center" nowrap bgcolor="FAF7F1" class="style13"><?=$lan=="cht"?"訂單日期":"Order Date"?></td>
          <td align="center" nowrap bgcolor="#FAF7F1" class="style13"><font class=c><?=$lan=="cht"?"處理情形":"Result"?></font></td>
        </tr>
<?PHP
...
?>
        <tr bgcolor="#FFFFFF" onmouseover="this.style.backgroundColor='#FFFFCC';" onmouseout="this.style.backgroundColor='#FFFFFF';">
          <td align="center" bgcolor="#FAF7F1" class="style13"><?=$num?></td>
...
?>
  ...
  <tr>
    <td height="13" align="center" valign="top" bgcolor="#F0E2C5"><table>
      <tr>
