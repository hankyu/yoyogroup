...
//===================斷定頁面是否重新整理========================
	...
	$body .= "Type of Payment：<font color=#639c00 size='3'><b>" .$order2_paykind. "</b></font>，please check <a href='http://".$XFUN_CONFIG[CONFIG_WEB_URL]."/orderonline/html/include/order_help.php?ck=e'>→Type of Payment</a>.<br><br>";
