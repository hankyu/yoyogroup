...
//===================斷定頁面是否重新整理========================
	...
	$body .= "您選擇的交易方式為：<font color=#639c00 size='3'><b>" .$order2_paykind. "</b></font>，請您儘快完成付款手續。<a href='#'>→付款方式按此查看</a><br><br>";
	...
	$body .= "<td width='150'　bgcolor='#659cd2'><div align='center'><font color='#FFFFFF' size='2'>".$c=$lan=="cht"?"價格":"Rates"."</td>";
	...
	if($lan=="cht"){
	$body .= "</table>";
	$body .= "<div align='center'><font color=#ec8000 size='3'>您需支付的總金額：" .$Total_Pay. "元 </font></div><br><br><br><font size='2'>請依照訂單所示金額及付款方式，於三日內完成付款手續，並於繳款完成後來電、傳真或e-mail告知飯店人員付款相關訊息。如逾期未完成付款確認，本訂單將自動取消不另行通知，且無法為您保留房間。<br><br>您也可至【<a href='http://".$XFUN_CONFIG['CONFIG_WEB_URL']."/orderonline/html/member/member_area.php'>訂單查詢</a>】系統查詢您的訂單處理進度。<br>若您有任何疑問歡迎您直接撥打客服專線，期待您的光臨，謝謝！<br><br><div align='center'>【客服專線：".$XFUN_CONFIG[CONFIG_WEB_PHONE]."】<br>【傳真號碼：".$XFUN_CONFIG[CONFIG_WEB_FAX]."】<br>【客服信箱：<a href='mailto:".$XFUN_CONFIG[CONFIG_WEB_EMAIL]."'>".$XFUN_CONFIG['CONFIG_WEB_EMAIL']."</a>】</div></font>";
	}else{
	$body .= "</table>";
...
//'========================主旨、收件者設定======================
	...
	$mail->Subject = $lan=="cht"?"友友大飯店訂房成功確認單":"Successful Booking – The Enterpriser Hotel Online Order System";
	$mail->Body    = $body;
...
<table width="90%" border="0" align="center" cellpadding="5" cellspacing="1" >
  <tr>
    <td align="center" valign="top" bgcolor="#F0E2C5">
	<?
	if($lan=="cht"){
	?>
	<font size="3"><B>【訂房成功！謝謝您使用友友大飯店線上訂房系統】</B></font>
	<div style='padding-left:0px; padding-right:80px; text-align:left;color:#660000; width:100%'>
	<ul>
...
如逾期未完成付款確認，本訂單將自動取消不另行通知，且無法為您保留房間。</li>
		...
		<li>客服專線：(02)2531-6767 / 傳真：(02)2511-9637 / 電子信箱：yoyo@ffh.com.tw</li>
		<li><font color=red><strong>如選擇傳真刷卡付款，也可以將刷卡單掃描為清晰圖檔，E-mail至：yoyo@ffh.com.tw</strong></font></li>	
    </ul>
	</div>
	<?
	}else{
	...
	<ul>
		...
		<li>TEL: 886-2-25316767  /  FAX: 886-2-25119637  /  E-Mail: yoyo@ffh.com.tw</li>
		<li><font color=red><strong>We also accept SCAN COPY of credit card authorization form (should be clear). Please e-mail to: yoyo@ffh.com.tw</strong></font></li>
	</ul>
	</div>
	<?}?>
	<br>
...
行　號: 013<br/>
銀行名: 國XX華銀行  台北分行<br />
戶　名: 友友大飯店有限公司 （負責人：XXX）<br />
帳　號: 123-45-123456-1 </strong><br />
</font>
<?
}
...
?>
  ...
  <tr>
    <td align="center" valign="top" bgcolor="#F0E2C5"><?=$mailmsg?></td>
  </tr>
</table>
</form>