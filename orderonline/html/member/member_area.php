...
?>
  <table border="0" cellpadding="0" cellspacing="0" width="740">
    ...
    <tr>
      ...
      <!-- <td rowspan="2" colspan="3"><img name="ordermenu_r2_c2" src="../room/img/ordermenu_r2_c2.jpg" width="675" height="93" border="0" id="ordermenu_r2_c2" alt="" /></td> -->
    ...
    <tr>
      ...
      <td colspan="3" bgcolor="#F0E2C5"><span style="padding-left:20px">
        <div style="padding-right:50px; text-align:right">
          <input type="button" name="query" value=" 查詢訂單 "  class="input03" onclick="location='../member/member_area.php'"/> <input type="button" name="query" value=" 購物車 "  class="input03" onclick="location='../room/cart_list.php'"/> <input type="button" name="query" value=" 訂房 "  class="input03" onclick="location='../room/index.php'"/></div>
      </span></td>
