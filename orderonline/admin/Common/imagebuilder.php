...
for ($i = 0; $i < $stringlength; $i++) {
	...
	//改變字串大小
	imagecopyresized ($buffer2, $buffer, 0, 0, 0, 0, 20 + mt_rand(0,12), 20 + mt_rand(0,12), 20, 20);
	...
	//imagecolortransparent ($rotated, imagecolorallocatealpha($rotated, $bgR, $bgG, $bgB,0));
	//imagecolortransparent( $rotated, $background_color );
